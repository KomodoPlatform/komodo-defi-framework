...
- Refactor `native_log` module, implement stdout/err streaming to persistent file without dependencies [#1751](https://github.com/KomodoPlatform/atomicDEX-API/pull/1751)
