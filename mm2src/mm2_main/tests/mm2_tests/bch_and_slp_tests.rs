...
/// Disabled for macOS because of the below transaction broadcast error, we should probably use a different passphrase for each CI machine.
/// ```text
/// ---- mm2_tests::bch_and_slp_tests::test_withdraw_cashaddresses stdout ----
/// 17 17:58:22, bch_and_slp_tests:41] log path: /var/folders/2s/h6hvv9ps03xgz_krkkstvq_r0000gn/T/mm2_2025-02-17_17-58-22-067_127.0.0.173/mm2.log
/// 17 17:58:22, for_tests:1575] sending rpc request {"userpass":"pass","method":"electrum","coin":"BCH","servers":[{"url":"tbch.loping.net:60001"},{"url":"bch0.kister.net:51001"}],"mm2":1} to http://127.0.0.173:7783
/// 17 17:58:22, bch_and_slp_tests:60] Object({"result": String("success"), "address": String("bchtest:qqgp9xh3435xamv7ghct8emer2s2erzj8gx3gnhwkq"), "balance": String("0.55131696"), "unspendable_balance": String("0"), "coin": String("BCH"), "required_confirmations": Number(1), "requires_notarization": Bool(false), "mature_confirmations": Number(100)})
/// 17 17:58:22, for_tests:1575] sending rpc request {"userpass":"pass","method":"withdraw","coin":"BCH","to":"bchtest:qr39na5d25wdeecgw3euh9fkd4ygvd4pnsury96597","amount":0.00001} to http://127.0.0.173:7783
/// 17 17:58:22, bch_and_slp_tests:74] {"tx_hex":"","tx_hash":"276631660ab313b13888ec7dd172bfdfe84237bca3dce68ce54f6df7677ef8c9","from":["bchtest:qqgp9xh3435xamv7ghct8emer2s2erzj8gx3gnhwkq"],"to":["bchtest:qr39na5d25wdeecgw3euh9fkd4ygvd4pnsury96597"],"total_amount":"0.55131696","spent_by_me":"0.55131696","received_by_me":"0.55129696","my_balance_change":"-0.00002","block_height":0,"timestamp":1739815102,"fee_details":{"type":"Utxo","coin":"BCH","amount":"0.00001"},"coin":"BCH","internal_id":"","transaction_type":"StandardTransfer","memo":null}
/// 17 17:58:22, for_tests:1575] sending rpc request {"userpass":"pass","method":"send_raw_transaction","coin":"BCH","tx_hex":""} to http://127.0.0.173:7783
/// thread 'mm2_tests::bch_and_slp_tests::test_withdraw_cashaddresses' panicked at 'BCH send_raw_transaction: {"error":"rpc:183] dispatcher_legacy:140] lp_coins:4976] utxo_common:2691] client:885] JsonRpcError { client_info: \"coin: BCH\", request: JsonRpcRequest { jsonrpc: \"2.0\", id: 7, method: \"blockchain.transaction.broadcast\", params: [String(\"\")] }, error: Response(bch0.kister.net:51001, Object({\"code\": Number(1), \"message\": String(\"the transaction was rejected by network rules.\\n\\ntxn-mempool-conflict (code 18)\\n\")})) }"}', mm2src/mm2_main/tests/mm2_tests/bch_and_slp_tests.rs:102:5
/// ```
#[test]
