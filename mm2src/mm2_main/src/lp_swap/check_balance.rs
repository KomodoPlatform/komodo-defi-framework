...
impl From<BalanceError> for CheckBalanceError {
    fn from(e: BalanceError) -> Self {
        match e {
            ...
            e @ BalanceError::MyAddressError(_)
            | e @ BalanceError::UnexpectedDerivationMethod(_)
            | e @ BalanceError::WalletStorageError(_) => CheckBalanceError::InternalError(e.to_string()),
