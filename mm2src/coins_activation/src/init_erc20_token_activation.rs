...
impl InitTokenActivationOps for EthCoin {
    ...
    async fn get_activation_result(
        ...
        let current_block = self
            ...
            .compat()
            .await
            .map_to_mm(EthTokenActivationError::Transport).map_mm_err()?;
        ...
        task_handle.update_in_progress_status(InitTokenInProgressStatus::RequestingWalletBalance).map_mm_err()?;
        let wallet_balance = self
            ...
            .await.map_mm_err()?;
        task_handle.update_in_progress_status(InitTokenInProgressStatus::ActivatingCoin).map_mm_err()?;
