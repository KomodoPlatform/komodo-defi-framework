...
fn convert_taker_to_maker_events(
    ...
    for TakerSavedEvent { event, timestamp } in event_it {
        ...
        match event {
            ...
            TakerSwapEvent::TakerFeeSent(tx_ident) => push_event!(MakerSwapEvent::TakerFeeValidated(tx_ident)),
            ...
            TakerSwapEvent::MakerPaymentReceived(tx_ident) => push_event!(MakerSwapEvent::MakerPaymentSent(tx_ident)),
