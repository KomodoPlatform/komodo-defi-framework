...
//! Initially, the implementation was restricted to non-WASM targets, which limited its utility in web-based environments.
//!
//! This module contains the WebSocket client code that has been ported and modified to achieve cross-platform compatibility.
//! The changes ensure that the WalletConnect client can function seamlessly in both native and WASM targets.
