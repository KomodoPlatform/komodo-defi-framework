...
impl ConnectionOptions {
    ...
    pub(crate) fn as_ws_request(&self) -> MmResult<HttpRequest<()>, RequestBuildError> {
        let url = self.as_url()?;
...
#[inline]
pub(crate) fn convert_subscription_result(res: SubscriptionResult) -> Result<SubscriptionId, SubscriptionError> {
    match res {
...
pub(super) mod native_tests {
    use crate::client::options::tests::{test_as_ws_request_impl, test_into_client_request_impl};
