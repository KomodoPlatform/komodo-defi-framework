...
use zcash_primitives::transaction::builder::Error as ZTxBuilderError;
    ...
    pub enum GenTxError {
        ...
        #[display(fmt = "Not enough {} to generate a tx: available {}, required at least {}", coin, available,
            required )]
        InsufficientBalance { coin: String, available: BigDecimal, required: BigDecimal, },
        ...
        TxReadError { hex: BytesJson, err: std::io::Error },
