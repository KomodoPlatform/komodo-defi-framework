...
// panicked at 'called `Result::unwrap()` on an `Err` value: z_coin:927] z_rpc:523] z_rpc:191] RpcClientInitErr(UpdateBlocksCacheErr(GetLiveLightClientError("All the current light clients are unavailable.")))', mm2src/coins/z_coin/tx_streaming_tests/wasm.rs:30:10
// #[wasm_bindgen_test]
