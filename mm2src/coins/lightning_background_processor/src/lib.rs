        ...
        UMH::Target: 'static + CustomMessageHandler,
    {
        ...
        let handle = thread::spawn(move || -> Result<(), std::io::Error> {
            let event_handler = DecoratingEventHandler {
                event_handler,
                net_graph_msg_handler: net_graph_msg_handler.as_deref(),
            };
...
mod tests {
    ...
    use lightning::ln::channelmanager::{ChainParameters, ChannelManager, SimpleArcChannelManager, BREAKDOWN_TIMEOUT};
    use lightning::ln::features::InitFeatures;
    use lightning::ln::msgs::{ChannelMessageHandler, Init};
    use lightning::ln::peer_handler::{IgnoringMessageHandler, MessageHandler, PeerManager, SocketDescriptor};
    use lightning::routing::network_graph::{NetGraphMsgHandler, NetworkGraph};
    ...
    struct Node {
        ...
        net_graph_msg_handler: Option<
            Arc<NetGraphMsgHandler<Arc<NetworkGraph>, Arc<test_utils::TestChainSource>, Arc<test_utils::TestLogger>>>,
        >,
        peer_manager: Arc<
            PeerManager<
                TestDescriptor,
    ...
    fn create_nodes(num_nodes: usize, persist_dir: String) -> Vec<Node> {
        ...
        for i in 0..num_nodes {
            ...
            let fee_estimator = Arc::new(test_utils::TestFeeEstimator {
    ...
    fn test_background_event_handling() {
        ...
        nodes[0]
            .node
            .handle_funding_locked(&nodes[1].node.get_our_node_id(), &bs_funding);
        ...
        nodes[1]
            .node
            .handle_funding_locked(&nodes[0].node.get_our_node_id(), &as_funding);
