...
pub mod hd_wallet;
use hd_wallet::{AccountUpdatingError, AddressDerivingError, AddressIdentifier, HDAccountOps, HDAddressId,
                HDAddressOps, HDCoinAddress, HDCoinHDAccount, HDExtractPubkeyError, HDPathAccountToAddressId,
