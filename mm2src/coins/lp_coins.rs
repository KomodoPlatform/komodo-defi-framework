...
pub type GenPreimageResult = MmResult<TxPreimageWithSig, TxGenError>;
...
pub struct RefundFundingSecretArgs<'a, Tx, Pubkey> {
    pub funding_tx: &'a Tx,
    pub time_lock: u64,
    pub maker_pubkey: &'a Pubkey,
...
pub struct GenTakerFundingSpendArgs<'a, Tx, Pubkey> {
    /// Taker payment transaction serialized to raw bytes
    pub funding_tx: &'a Tx,
    /// Maker's pubkey
    pub maker_pub: &'a Pubkey,
    /// Taker's pubkey
    pub taker_pub: &'a Pubkey,
...
pub struct ValidateTakerPaymentArgs<'a, Tx, Pubkey> {
    /// Taker payment transaction serialized to raw bytes
    pub taker_tx: &'a Tx,
    /// Taker will be able to refund the payment after this timestamp
    pub time_lock: u64,
...
pub struct GenTakerPaymentSpendArgs<'a, Tx, Pubkey> {
    /// Taker payment transaction serialized to raw bytes
    pub taker_tx: &'a Tx,
    /// Taker will be able to refund the payment after this timestamp
    pub time_lock: u64,
...
pub trait SwapOpsV2: CoinAssocTypes + Send + Sync + 'static {
    ...
    async fn gen_taker_payment_spend_preimage(
        &self,
        args: &GenTakerPaymentSpendArgs<'_, Self::Tx, Self::Pubkey>,
        swap_unique_data: &[u8],
    ) -> GenPreimageResult;
    ...
    async fn validate_taker_payment_spend_preimage(
        &self,
        gen_args: &GenTakerPaymentSpendArgs<'_, Self::Tx, Self::Pubkey>,
