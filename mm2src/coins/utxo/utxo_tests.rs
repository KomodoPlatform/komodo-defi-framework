...
#[test]
fn test_utxo_validate_valid_and_invalid_secret_hash() {
    let client = electrum_client_for_test(RICK_ELECTRUM_ADDRS);
    let coin = utxo_coin_for_test(client.into(), None, false);
    let tx_hex = hex::decode("").unwrap();
    let secret_hash = &hex::decode("9da937e5609680cb30bff4a7661364ca1d1851c2506fa80c443f00a3d3bf7365").unwrap();
    let secret = coin.extract_secret(&*dhash160(&secret_hash), &tx_hex).unwrap();
    // Test expected to pass at this point as we're using a valid secret_hash against a valid secret
    assert!(coin.validate_secret_hash(secret_hash, secret.as_slice()));

    // Test expected to fail at this point as we're using an invalid secret_hash against a valid secret
    let secret_hash = &hex::decode("9da937e5609680cb30bff4a7661364ca1d1851c2506fa80c443f00a3d3bf7366").unwrap();
    assert!(!coin.validate_secret_hash(&*dhash160(secret_hash), secret.as_slice()));
}
