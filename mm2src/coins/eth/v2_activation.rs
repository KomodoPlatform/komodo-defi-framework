use super::*;
use crate::eth::erc20::{get_enabled_erc20_by_contract_and_platform, get_token_decimals};
...
impl EthCoin {
    pub async fn initialize_erc20_token(
        ...
        if is_custom {
            match get_enabled_erc20_by_contract_and_platform(&ctx, protocol.token_addr, &protocol.platform).await {
                Ok(Some(token)) => {
