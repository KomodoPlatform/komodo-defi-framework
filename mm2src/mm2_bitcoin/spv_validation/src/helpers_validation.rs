...
pub async fn validate_headers(
    ...
    algorithm: &Option<DifficultyAlgorithm>,
) -> Result<(), SPVError> {
    ...
    for header in headers.into_iter() {
        ...
        if previous_height != 0 && constant_difficulty && difficulty_check && cur_bits != prev_bits {
            return Err(SPVError::UnexpectedDifficultyChange);
        }
        if previous_height != 0 && !validate_header_prev_hash(&header.previous_header_hash, &previous_hash) {
        ...
        if let Some(algo) = algorithm {
            if !constant_difficulty
                && difficulty_check
                && cur_bits
                    != next_block_bits(coin, header.time, previous_header, previous_height, storage, algo).await?
            {
...
mod tests {
    ...
    fn test_block_headers_no_difficulty_check() {
        ...
        let previous_header: BlockHeader = "".into();
    ...
    fn test_block_headers_difficulty_check() {
        ...
        let previous_header: BlockHeader = "00c0d933bd3c3dcf14027754c7c8f7190a79b699188c8b24f49204000000000000000000ce2b1e4dc6cb44fae781df459428382d4b5be52766f67a42725cc0d78e00784d352e166278100a173d95ee89".into();
        block_on(validate_headers(
            "BTC",
            previous_header,
            724608,
